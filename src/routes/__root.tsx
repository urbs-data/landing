...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      {
        title: "Urbs Data | Ingeniería de datos, IA y automatización",
      },
      {
        name: "description",
        content:
          "Integramos sistemas, ordenamos métricas y automatizamos procesos para que las empresas decidan con datos confiables.",
      },
    ],
    links: [
      {
